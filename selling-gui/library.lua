...
local Topbar = add("Frame", { Parent = Window, Name = [[Topbar]], BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 25), BorderColor3 = Color3.fromRGB(40, 40, 40), BackgroundColor3 = Color3.fromRGB(35, 35, 35),})
local Sidebar = add("Frame", { Parent = Window, Name = [[Sidebar]], BackgroundTransparency = 1, AnchorPoint = Vector2.new(0, 1), Size = UDim2.new(0, 115, 1, -26), ClipsDescendants = true, BorderColor3 = Color3.fromRGB(40, 40, 40), Position = UDim2.new(0, 0, 1, 0), BackgroundColor3 = Color3.fromRGB(30, 30, 30),})
local Tabs = add("Frame", { Parent = Window, Name = [[Tabs]], BackgroundTransparency = 1, AnchorPoint = Vector2.new(1, 1), BorderSizePixel = 0, Size = UDim2.new(1, -116, 1, -26), BorderColor3 = Color3.fromRGB(0, 0, 0), Position = UDim2.new(1, 0, 1, 0), BackgroundColor3 = Color3.fromRGB(25, 25, 25),})
...
local ProfileCard = add("Frame", { Parent = Sidebar, Name = [[ProfileCard]], BackgroundTransparency = 1, AnchorPoint = Vector2.new(0, 1), Size = UDim2.new(1, 0, 0, 45), BorderColor3 = Color3.fromRGB(40, 40, 40), Position = UDim2.new(0, 0, 1, 0), BackgroundColor3 = Color3.fromRGB(30, 30, 30),})
...
local WindowRounding = add("UICorner", { Parent = Window, CornerRadius = UDim.new(0,6) })
